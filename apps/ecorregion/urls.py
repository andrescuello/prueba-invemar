...
from apps.ecorregion.views import index_ecorregion, EcorregionList, EcorregionCreate, EcorregionUpdate, EcorregionDelete, ReporteEcorregionExcel
...
urlpatterns = [
	...
	url(r'^ecorregionexcel$', ReporteEcorregionExcel.as_view(), name="ecorregion_excel"),
